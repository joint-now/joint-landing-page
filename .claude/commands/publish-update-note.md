...
```
/publish-update-note update-note-YYMMDD.md
```

인자(`$ARGUMENTS`)로 파일명을 받습니다. 예: `update-note-260301.md`
...
`../joint-docs/products/update-notes/public/$ARGUMENTS` 를 읽습니다.
...
### Step 6. 이전 최신 글(PREV) index.html 수정
